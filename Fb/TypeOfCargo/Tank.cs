...
{
    class Tank : AbstractTypeOfCargoTransportation, IGetMass
    {
        //ширина, высота и длина - внутренние, соответственно высота - это диаметр цистерны
        private double densityOfMaterial;

        public double DensityOfMaterial { get => densityOfMaterial; set => densityOfMaterial = value; }

        protected Tank() { }
        public Tank(TypeOfTransportation typeOfTransportation, double width, double length, double height, double tara, double densityOfMaterial) : base(typeOfTransportation, width, length, height, tara)
        {
